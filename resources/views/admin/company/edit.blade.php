        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="ibox ">
                        ...
                        {{ Form::open(['route'=>['admin.update.company',$result->id],'class'=>'classname','id'=>'myForm','files'=>'true'])}}
                        ...
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Company Name</label>
                                    ...
                                    <div class="col-sm-4">
                                       {!! Form::text('company',$result->company,['class' => 'form-control', 'style'=>"text-transform:capitalize"]) !!}
                               ...
                               <div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label"> Contact Person Email</label>
                                    ...
                                    <div class="col-sm-4">
                                       {!! Form::text('contact_person_email', $result->contact_person_email,['class' => 'form-control', 'style'=>"text-transform:capitalize"]) !!}
